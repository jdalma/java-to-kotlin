...
class LongestLegOverTests {
    ...
    fun is_absent_when_no_legs() {
        ...
        // nullable
        assertNull(longestOver(emptyList(), Duration.ZERO))
    }
    ...
    fun is_absent_when_no_legs_long_enough() {
        ...
        // nullable
        assertNull(longestOver(legs, oneDay))
    }
    ...
    fun is_longest_leg_when_one_match() {
        ...
        assertEquals(
            "one day",
            longestOver(legs, Duration.ofMillis(-1))
            !!.description
        )
    }
    ...
    fun is_longest_leg_when_more_than_one_match() {
        ...
        assertEquals(
            "one day",
            longestOver(legs, Duration.ofMinutes(59))
            ?.description
        )
    }
